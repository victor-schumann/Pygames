"""This is a clone of 'working_space_scroll', with the following change: background scrolling is now natural and automatic, without keybinding association.
Reminders:
Fix Up/Down keybindings next.
"""
...
while True:
    if clock() > nextFrame:                         # We only animate our character every 80ms.
        ...
        scrollBackground(-2,0)                      # The player is moving right, so we scroll the background left
